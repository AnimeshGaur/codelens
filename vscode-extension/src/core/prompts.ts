...
export function buildAnalysisPrompt(files: FileContent[]): { userPrompt: string; systemPrompt: string } {
...
export function buildOverviewPrompt(filePaths: string[]): { userPrompt: string; systemPrompt: string } {
